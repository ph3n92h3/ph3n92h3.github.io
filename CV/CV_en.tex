...
\begin{itemize}[noitemsep,nolistsep]
    \item \textbf{General Relativity and Quantum Cosmology} cosmological inflation, black hole, modified gravity, cosmological perturbation, Compact stars
\end{itemize}
...
\begin{itemize}[noitemsep,nolistsep]
    ...
    \item \textbf{High Energy Physics - Theory} string theory, supersymmetric field theory, field theory in curved space, beyond SM, particle physics
\end{itemize}
...
\begin{itemize}[noitemsep,nolistsep]
    \item Blood donations totaled 1400 mL for five times \hfill \textit{2020 $\sim$ 2022}
