...
\begin{itemize}
    \item \textbf{High Energy Physics - Theory} Covariant Phase Space Formalism, AdS/CFT Correspondence, Holographic Entanglement Entropy
    \item \textbf{General Relativity and Quantum Cosmology} Inflation, Cosmology, Black Hole, Compact Star
\end{itemize}

\textbf{Other Interest}
\begin{itemize}
    \item \textbf{High Energy Physics - Theory} SUSY, CFT
\end{itemize}
...
\textbf{High Energy Physics - Theory}

\smallskip \quad \textit{Covariant Phase Space Formalism} \hfill Oct. 2023 - Present

\textbf{General Relativity and Quantum Cosmology}

\smallskip \quad \textit{Modified Gravity and Astrophysics} \hfill Feb. 2022 - Nov. 2022
...
\smallskip \quad \textit{Modified Gravity and Cosmology} \hfill Feb. 2022 - Oct. 2022
