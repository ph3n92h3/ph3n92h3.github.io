...
\usepackage{tikz}\usebackgroundtemplate{\tikz\node[opacity=0.15]{\includegraphics[width=\paperwidth]{./figs/background.jpeg}};}
...
\begin{frame}{Research Experience: Condensed Matter - Materials Science}
    ...
    \begin{figure}
        \centering
        \includegraphics[scale=0.59]{./figs/Laser Etching-Assisted Patterning of Silicon Micro-Nano Structures.png}
    \end{figure}
\end{frame}
...
%     \begin{figure}
%         \centering
%         \includegraphics[scale=0.2]{./figs/2210.01574.png}
%     \end{figure}
% \end{frame}
...
%     \begin{figure}
%         \centering
%         \includegraphics[scale=0.29]{./figs/2211.13233.1.pdf}
%     \end{figure}
% \end{frame}
...
%     \begin{figure}
%         \centering
%         \includegraphics[scale=0.32]{./figs/2211.13233.2.pdf}
%     \end{figure}
% \end{frame}
...
%     \begin{figure}
%         \centering
%         \includegraphics[scale=0.31]{./figs/3.1.pdf}
%     \end{figure}
% \end{frame}
...
%     \begin{figure}
%         \centering
%         \includegraphics[scale=0.39]{./figs/3.2.pdf}
%     \end{figure}
% \end{frame}
