...
HandleLidSwitchDocked=suspend #ignore
```
...
bind = $mainMod, T, exec, pot translate
...
```conf
preload = /home/ph2/OneDrive_ph3n92h3/Pictures/wallpaper.jpeg
wallpaper = eDP-1,contain:/home/ph2/OneDrive_ph3n92h3/Pictures/wallpaper.jpeg
```
